...
export default function App() {
  ...
  const guardar = () => {
    ...
    setVarnotas(varnotas => [...varnotas, {
      identificacion: identificacion, nombres: nombres, asignatura: asignatura,
      nota1: nota1, nota2: nota2, nota3: nota3, definitiva: definitiva, observacion: observacion}]);
  ...
  let buscar = (idenbuscar) => {
    let ident = varnotas.find(notita => notita.identificacion == identificacion);
    if (ident != undefined) {
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={{ color: 'lightblue', fontSize: 30, margin: 40, fontFamily:'arial black' }}>CALCULADORA DE NOTAS 🧮</Text>
